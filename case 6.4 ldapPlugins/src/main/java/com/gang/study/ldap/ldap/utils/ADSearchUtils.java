...
//    }
//
//    public static List<ADBaseTO> searchInvoke(ObjectClass objectClass, ADUtilities utilities, String baseContext, LdapConnection connction) {
//        Set<Attributes> backSet = utilities.searchAttrByType(objectClass, getNativeFilter(ADSearchType.ALL, null, null, objectClass), baseContext, connction);
...
//
//
//    public static List<ADBaseTO> getTO(ObjectClass objectClass, ADUtilities utilities, String key, String value, String baseContext, LdapConnection connction) {
//
//        Set<Attributes> backSet = utilities.searchAttrByType(objectClass, getNativeFilter(ADSearchType.EQUALS, key, value, objectClass), baseContext, connction);
//        List<ADBaseTO> list = getBaseTOList(objectClass, backSet);
//        LOG.info("------> backset :{} <-------", JSONObject.toJSONString(list));
//        return list;
//    }
...
//                try {
//                    FieldUtils.writeField(field, baseTO, ADUtilities.getAttributorValue(attributes.get(adAlias.toLowerCase())));
