...
public class ProductController {
    ...
    public String buyProduct(@PathVariable("productId") String orderId) {
        ...
        // 更新账户
        NoDataProduct product = productRepository.getProductById(CommonOrderTO.getAccountId());
        product.setProductNum(product.getProductNum().subtract(CommonOrderTO.getProductNum()));
