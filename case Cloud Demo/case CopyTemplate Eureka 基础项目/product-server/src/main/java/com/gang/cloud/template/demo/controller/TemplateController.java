...
public class TemplateController {
    ...
    public String get() {
        ...
        logger.info("------> request : {} <-------", JSONObject.toJSONString(accountFeignClient.get("user-server")));
        logger.info("------> request : {} <-------", JSONObject.toJSONString(userFeignClient.get("user-server")));
        return "success";
    }
