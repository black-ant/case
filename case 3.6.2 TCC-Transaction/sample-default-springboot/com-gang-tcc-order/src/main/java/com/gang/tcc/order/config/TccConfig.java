package com.gang.tcc.order.config;
...
public class TccConfig {
    ...
    public SpringJdbcTransactionRepository springJdbcTransactionRepository() {
        ...
        springJdbcTransactionRepository.setDomain("PROVIDER");    //domain
        springJdbcTransactionRepository.setTbSuffix("_PROVIDER"); //配置tcc日志表名称后缀：这里为：tcc_transaction_consumer
