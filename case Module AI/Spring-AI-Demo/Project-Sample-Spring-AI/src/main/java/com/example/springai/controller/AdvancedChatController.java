...
public class AdvancedChatController {
    ...
    public String chatWithHistory(@RequestBody AdvancedChatRequest request) {
        return advancedChatService.chatWithHistory(
                request.getHistory(),
                request.getMessage()
        );
    }
