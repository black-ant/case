...
/**
 * @Classname FractionToRecurringDecimal166
 * @Description TODO
 * @Date 2021/8/15
 * @Created by zengzg
 */
public class FractionToRecurringDecimal166 extends AbstractAlgorithmService {

    public static void main(String[] args) {
        new FractionToRecurringDecimal166().run();
    }
