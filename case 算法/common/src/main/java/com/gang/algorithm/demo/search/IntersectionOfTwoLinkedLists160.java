...
/**
 * @Classname IntersectionOfTwoLinkedLists160
 * @Description TODO
 * @Date 2021/8/16
 * @Created by zengzg
 */
public class IntersectionOfTwoLinkedLists160 extends AbstractAlgorithmService {


    public static void main(String[] args) {
        new IntersectionOfTwoLinkedLists160().run();
    }
